...
初始访问：http://localhost:8080/freewebwork/register(其实无论访问什么，都会重定向到此处登录)，账号：158，密码：123123.
定时任务控制访问：http://localhost:8080/freewebwork/static/html/task/taskPage.html，登录后手动输入地址访问(未做认证跳转指定页面功能)。
