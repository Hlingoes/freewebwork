package com.cn.henry.freewebwork.utils.Excel;
 ...
 * @modify Hlingoes 2017-9-29 23:24:11 根据poi-3.17.jar 替换getCellType()方法为getCellTypeEnum()
 */
public class ExcelUtil {
    ...
    static {
        ...
        validateMap.put(Date.class, new CellType[]{CellType.NUMERIC, CellType.NUMERIC});
     ...
     * @return
     */
    private static String getCellTypeEnumByInt(CellType cellType) {
    ...
    private static String validateCell(Cell cell, Field field, int cellNum) {
        ...
        String result = null;
        CellType[] cellTypesArr = validateMap.get(field.getType());
        if (cellTypesArr == null) {
        ...
        if (cell == null
            ...
            List<CellType> cellTypes = Arrays.asList(cellTypesArr);
            ...
            if (!(cellTypes.contains(cell.getCellTypeEnum()))
                ...
                for (int i = 0; i < cellTypes.size(); i++) {
                	CellType intType = cellTypes.get(i);
                    strType.append(getCellTypeEnumByInt(intType));
