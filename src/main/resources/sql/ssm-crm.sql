/* notice : create table as order for setting FOREIGN KEY 
 * base on project: https://github.com/fankay/crm
 * thanks for sharing
 * */
...
insert  into `t_user`(`id`,`username`,`password`,`tel`,`createtime`,`state`) 
values 
(1,'admin','f76a319dbd7ad4d3c153c775ad503f37','138','2016-04-28 09:51','正常'),
(2,'张小龙','f76a319dbd7ad4d3c153c775ad503f37','13800000001','2016-04-28 09:51','正常'),
(3,'刘莉莉','f76a319dbd7ad4d3c153c775ad503f37','13800000002','2016-04-28 09:51','正常'),
(4,'刘潇潇','f76a319dbd7ad4d3c153c775ad503f37','13800000003','2016-04-28 09:51','正常'),
(5,'费希特','f76a319dbd7ad4d3c153c775ad503f37','13800000004','2016-04-28 09:51','禁用'),
(6,'赵玲玲','f76a319dbd7ad4d3c153c775ad503f37','13800000005','2016-04-28 09:51','禁用'),
(7,'马历涛','f76a319dbd7ad4d3c153c775ad503f37','13800000006','2016-04-28 09:51','正常'),
(8,'李四','f76a319dbd7ad4d3c153c775ad503f37','18900000000','2016-04-29 15:05','正常'),
(9,'王武武','f76a319dbd7ad4d3c153c775ad503f37','13700000000','2016-04-29 15:09','正常'),
...
insert  into `t_customer`(`id`,`custname`,`contact`,`tel`,`address`,`email`,`wechar`,`qq`,`mark`,`userid`,`progress`,`progresstime`,`createtime`) 
values 
(1,'北京即可科技','李思凯','18939870345','北京长安街34号','lisikai@jike.com','lisika','1100000','CEO',1,'初访',NULL,'2016-05-03 10:23'),
(2,'赵丽丽','','17000987909','','','','','',1,'无',NULL,'2016-05-03 11:21'),
(3,'美国微软科技有限公司','比尔','010-8899776','北京中关村','','','','',1,'无',NULL,'2016-05-03 13:01'),
(4,'Google','布林','089-0099932','美国加利福尼亚','','','','<br>admin转交过来的客户   jack转交过来的客户',1,'报价','2016-05-05 08:36','2016-05-03 13:09'),
(5,'谢利英','','15833476589','西安电子科技大学计算机学院','xie.edu@163.com','xieliying','','',1,'无',NULL,'2016-05-03 13:13'),
(6,'豆瓣网络','阿贝','029-8899765','西安市长安南路119号凌翼大楼11层','dou@ban.com','','','<br>admin转交过来的客户   jack转交过来的客户',1,'无',NULL,'2016-05-03 13:15'),
(7,'张武柳','','1560000998','','','','','',NULL,'无',NULL,'2016-05-03 14:05');
...
insert  into `t_progress`(`id`,`progress`,`mark`,`createtime`,`custid`,`userid`) 
values 
(1,'初访','MultipartFile[]','2016-05-01 11:16',1,1),
(2,'意向','对方对我们的OA产品有意向','2016-05-02 11:18',2,1),
(3,'报价','直接报价了500w，对方考虑中','2016-05-03 11:19',1,1),
(4,'成交','购买了MR-98服务器','2016-05-03 11:21',4,1),
(5,'意向','对MR-90型号服务器有意向，需要多次跟进','2016-05-04 12:55',7,1),
(6,'暂时搁置','对方对我们的产品没有兴趣，以后联系','2016-05-04 14:21',3,1),
(7,'意向','报价2300w，对方确认中','2016-05-04 17:07',7,11),
(8,'初访','价格降低后，对方很开心','2016-05-04 17:48',3,1),
(9,'初访','最终','2016-05-04 17:48',3,1),
(10,'成交','1500w拿下','2016-05-04 17:49',3,1),
(11,'成交','再次购买1000T的SSD硬盘','2016-05-04 17:52',4,1),
(12,'意向','对xx感兴趣','2016-05-05 08:35',4,1),
(13,'报价','报价100w','2016-05-05 08:36',4,1);
...
insert  into `t_progress_file`(`id`,`filename`,`path`,`createtime`,`progressid`,`custid`,`userid`) 
values 
(1,'v-1.png','http://7xs9b4.com1.z0.glb.clouddn.com/FjqEQ8F3FJNw2gqfypI0vuWyZaPy','2016-05-04 11:19',2,2,1),
(2,'1.jpg','http://7xs9b4.com1.z0.glb.clouddn.com/FgmkyaGFLSy6aZkUtV9LoeQP1tFB','2016-05-04 11:19',2,2,1),
(4,'OA微信接口调用API.docx','http://7xs9b4.com1.z0.glb.clouddn.com/FnYo6z5H0XC_G-EN1lAsvShgcEje','2016-05-04 14:21',6,3,1),
(5,'crm.sql','http://7xs9b4.com1.z0.glb.clouddn.com/FjFlNKDtl6v8h4-HzGz5EAsAOo58','2016-05-04 14:21',6,3,1),
(6,'douban.sql','http://7xs9b4.com1.z0.glb.clouddn.com/Fq5m9jrGuRaP4Qbr_lLga6ldDr1N','2016-05-04 17:49',10,3,1),
(7,'generatorConfig.xml','http://7xs9b4.com1.z0.glb.clouddn.com/FuJVniRT8JKfP1uJUVhbMzL36dWj','2016-05-05 08:35',12,4,1),
(8,'douban.sql','http://7xs9b4.com1.z0.glb.clouddn.com/Fq5m9jrGuRaP4Qbr_lLga6ldDr1N','2016-05-05 08:36',13,4,1);
